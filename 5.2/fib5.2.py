...
def postKey(n):
    ...
    jsona = {"bark":1,"num":n,"button":4,"questionType":"RFIB","isJJ":1,"submitNum":1,"pId":"8dd66b6b6348c45180622b5b3522688f"}
...
def addInfo(title, original, sample, url, n, number):
    ...
    # p._element.rPr.rFonts.set(qn('w:eastAsia'), u'宋体')
...
if __name__ == "__main__":
    ...
    document.add_heading('FIB 5.2', 0)

    for i in range(0, 75):  # 75
        # print(i)
        postKey(i)
        time.sleep(0.5)
    # postKey(0)
    document.save('FIB 5.2.docx')
